...
- `Cloud/CloudSync.swift` — the CloudKit actor: pairing/share lifecycle, publish (+ status log), refresh, nudge, moment, receipts, subscriptions, unpair. Largest and most safety-critical file.
