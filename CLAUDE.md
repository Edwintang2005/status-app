...
9. **Invite link auto-closes.** The share URL is a bearer token; `closeInviteIfPartnerJoined` revokes public joining once a partner is proven on the share. `lockPairing`'s promote-and-close save must stay a single atomic modify.
